...
(function(){
  function addGuide(){
    ...
    section.innerHTML=`<div class="lore-guide-promo-inner reveal">
      ...
      <div class="lore-guide-grid">
        ...
        <a href="ways-to-earn.html" class="lore-guide-item"><b>🚀 <span>Business Owner</span></b><small>Build an opportunity</small><em>Explore →</em></a>
  ...
  function loadBusinessLink(){
    if(document.querySelector('script[data-business-link]')) return;
    var script=document.createElement('script');
    script.src='business-link.js';
    script.defer=true;
    script.setAttribute('data-business-link','true');
